 ...
 */
package com.tarpan.www.suffixtree;
...
class EdgeBag implements Map<Character, Edge> {
	...
	public Edge get(Object maybeCharacter) {
		return get(((Character) maybeCharacter).charValue()); // throws if cast
																// fails.
	}
	...
	/**
	 * A trivial implementation of sort, used to sort chars[] and values[]
	 * according to the data in chars.
	 * 
